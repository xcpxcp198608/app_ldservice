...
import com.wiatec.ldservice.adapter.ChannelAdapter;
import com.wiatec.ldservice.adapter.LiveChannelAdapter;
import com.wiatec.ldservice.databinding.ActivityChannelBinding;
...
import com.wiatec.ldservice.pay.PayInfo;
import com.wiatec.ldservice.pay.PayPalConfig;
import com.wiatec.ldservice.pay.PayPalManager;
...
import com.wiatec.ldservice.presenter.ChannelPresenter;
...
public class ChannelActivity extends BaseActivity<ChannelPresenter> implements IChannel,
    ...
    @Override
    public void onPayVerify(boolean execute, PayResultInfo payResultInfo) {
        if(execute && payResultInfo != null){
