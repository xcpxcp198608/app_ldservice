...
import com.wiatec.ldservice.adapter.PlayChannelAdapter;
import com.wiatec.ldservice.databinding.ActivityPlayBinding;
...
//        finish();
    ...
    public void launchApp(String packageName) {
        if(AppUtil.isInstalled(packageName)) {
            ...
            AppUtil.launchApp(PlayActivity.this, Constant.package_name.market);
        }
        finish();
    }
