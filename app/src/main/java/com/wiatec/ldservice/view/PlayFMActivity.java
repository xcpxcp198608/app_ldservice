...
import com.wiatec.ldservice.databinding.ActivityFmPlayBinding;
import com.wiatec.ldservice.instance.Application;
import com.wiatec.ldservice.instance.Constant;
import com.wiatec.ldservice.manager.PlayManager;
...
//        finish();
    ...
    public void launchApp(String packageName) {
        if(AppUtil.isInstalled(packageName)) {
            ...
            AppUtil.launchApp(PlayFMActivity.this, Constant.package_name.market);
        }
        finish();
    }
    ...
    private void showImage(){
        ...
        ImageMaster.load(PlayFMActivity.this, icon, binding.ivFM);
    }
